...
-- Date        : Mon Aug 28 09:39:26 2023
-- Host        : LT155345 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/sources/S3_ES_Fall-23/ES_PYNQ_Z2_Ref/ecen427_v0.4/ecen427.srcs/sources_1/bd/system/ip/system_fit_timer_0_0/system_fit_timer_0_0_sim_netlist.vhdl
...
entity system_fit_timer_0_0_Divide_part is
  port (
  ...
  attribute ORIG_REF_NAME of system_fit_timer_0_0_Divide_part : entity is "Divide_part";
end system_fit_timer_0_0_Divide_part;

architecture STRUCTURE of system_fit_timer_0_0_Divide_part is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \system_fit_timer_0_0_Divide_part__parameterized0\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \system_fit_timer_0_0_Divide_part__parameterized0\ : entity is "Divide_part";
end \system_fit_timer_0_0_Divide_part__parameterized0\;

architecture STRUCTURE of \system_fit_timer_0_0_Divide_part__parameterized0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \system_fit_timer_0_0_Divide_part__parameterized0_0\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \system_fit_timer_0_0_Divide_part__parameterized0_0\ : entity is "Divide_part";
end \system_fit_timer_0_0_Divide_part__parameterized0_0\;

architecture STRUCTURE of \system_fit_timer_0_0_Divide_part__parameterized0_0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \system_fit_timer_0_0_Divide_part__parameterized1\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \system_fit_timer_0_0_Divide_part__parameterized1\ : entity is "Divide_part";
end \system_fit_timer_0_0_Divide_part__parameterized1\;

architecture STRUCTURE of \system_fit_timer_0_0_Divide_part__parameterized1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \system_fit_timer_0_0_Divide_part__parameterized1_1\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \system_fit_timer_0_0_Divide_part__parameterized1_1\ : entity is "Divide_part";
end \system_fit_timer_0_0_Divide_part__parameterized1_1\;

architecture STRUCTURE of \system_fit_timer_0_0_Divide_part__parameterized1_1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \system_fit_timer_0_0_Divide_part__parameterized1_2\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \system_fit_timer_0_0_Divide_part__parameterized1_2\ : entity is "Divide_part";
end \system_fit_timer_0_0_Divide_part__parameterized1_2\;

architecture STRUCTURE of \system_fit_timer_0_0_Divide_part__parameterized1_2\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \system_fit_timer_0_0_Divide_part__parameterized1_3\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \system_fit_timer_0_0_Divide_part__parameterized1_3\ : entity is "Divide_part";
end \system_fit_timer_0_0_Divide_part__parameterized1_3\;

architecture STRUCTURE of \system_fit_timer_0_0_Divide_part__parameterized1_3\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_fit_timer_0_0_FIT_timer is
  port (
    Clk : in STD_LOGIC;
    Rst : in STD_LOGIC;
    Interrupt : out STD_LOGIC
  ...
  attribute C_EXT_RESET_HIGH of system_fit_timer_0_0_FIT_timer : entity is 1;
  attribute C_FAMILY : string;
  attribute C_FAMILY of system_fit_timer_0_0_FIT_timer : entity is "zynq";
  attribute C_INACCURACY : integer;
  attribute C_INACCURACY of system_fit_timer_0_0_FIT_timer : entity is 0;
  attribute C_NO_CLOCKS : integer;
  attribute C_NO_CLOCKS of system_fit_timer_0_0_FIT_timer : entity is 1000000;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_fit_timer_0_0_FIT_timer : entity is "FIT_timer";
end system_fit_timer_0_0_FIT_timer;

architecture STRUCTURE of system_fit_timer_0_0_FIT_timer is
  signal CE : STD_LOGIC;
...
begin
\Using_SRL16s.SRL16s[1].Divide_I\: entity work.system_fit_timer_0_0_Divide_part
     port map (
      CE => CE,
      Clk => Clk,
      Rst => Rst,
...
\Using_SRL16s.SRL16s[2].Divide_I\: entity work.\system_fit_timer_0_0_Divide_part__parameterized0\
     port map (
      CE => CE_0,
      CE_0 => CE,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[3].Divide_I\: entity work.\system_fit_timer_0_0_Divide_part__parameterized0_0\
     port map (
      CE => CE_2,
      CE_0 => CE_0,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[4].Divide_I\: entity work.\system_fit_timer_0_0_Divide_part__parameterized1\
     port map (
      CE => CE_4,
      CE_0 => CE_2,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[5].Divide_I\: entity work.\system_fit_timer_0_0_Divide_part__parameterized1_1\
     port map (
      CE => CE_6,
      CE_0 => CE_4,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[6].Divide_I\: entity work.\system_fit_timer_0_0_Divide_part__parameterized1_2\
     port map (
      CE => CE_8,
      CE_0 => CE_6,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[7].Divide_I\: entity work.\system_fit_timer_0_0_Divide_part__parameterized1_3\
     port map (
      CE => CE_8,
      Clk => Clk,
      Clk_En_I_1 => Clk_En_I_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_fit_timer_0_0 is
  port (
    Clk : in STD_LOGIC;
    Rst : in STD_LOGIC;
    Interrupt : out STD_LOGIC
  ...
  attribute NotValidForBitStream of system_fit_timer_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_fit_timer_0_0 : entity is "system_fit_timer_0_0,fit_timer,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of system_fit_timer_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of system_fit_timer_0_0 : entity is "fit_timer,Vivado 2020.2";
end system_fit_timer_0_0;

architecture STRUCTURE of system_fit_timer_0_0 is
  attribute C_EXT_RESET_HIGH : integer;
...
begin
U0: entity work.system_fit_timer_0_0_FIT_timer
     port map (
      Clk => Clk,
      Interrupt => Interrupt,
      Rst => Rst
