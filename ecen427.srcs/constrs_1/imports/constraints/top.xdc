## Reference: https://github.com/Xilinx/PYNQ/blob/master/boards/Pynq-Z2/base/vivado/constraints/base.xdc
...
#set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_tri_io[5] pwm0_0_0}]
...
#set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_tri_io[9] pwm0_1_0}]
#set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_tri_io[10]}]
#set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_tri_io[11] pwm0_2_0}]
...
# WITHOUT UART
#set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_intr_en_tri_io[0]}]; #0
#set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_no_intr_tri_io[0]}];   #1
#set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_intr_en_tri_io[1]}]; #2
#set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_intr_en_tri_io[2]}]; #3
#set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_no_intr_tri_io[1]}];   #4
#set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {pwm0_0_0}];                #5 (pwm timer 0)
#set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_no_intr_tri_io[2]}];   #6
#set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_no_intr_tri_io[3]}];   #7
#set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_no_intr_tri_io[4]}];   #8
#set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports {pwm0_1_0}];                #9 (pwm timer 1)
#set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_no_intr_tri_io[5]}];   #10
#set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {pwm0_2_0}];                #11(pwm timer 2)
#set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_no_intr_tri_io[6]}];   #12
#set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports {arduino_gpio_no_intr_tri_io[7]}];   #13
...
#set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports pwm0_0_0]; # pin5(TMR0)
#set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports pwm0_1_0]; #pin 9(TMR1)
#set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports pwm0_2_0]; #pin 11(TMR2)
## Arduino direct I2C
